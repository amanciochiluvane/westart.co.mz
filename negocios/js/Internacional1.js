                                                    ...
                                                    document.addEventListener('DOMContentLoaded', function () {
                                                        ...
                                                        let QUERY = encodeURIComponent('*[_type == "destaque" && destaques == "Internacional"]');
                                                        ...
                                                        fetch(PROJECT_URL)
                                                            ...
                                                            .then(({ result }) => {
                                                                ...
                                                                if (result.length > 0) {
                                                                    ...
                                                                    const newsContainer = document.getElementById('internacional-container');
                                                                            ...
                                                                            <div class="cs-entry__outer">
                                                                                ...
                                                                                <div class="cs-entry__inner cs-entry__content">
                                                                                    ...
                                                                                    <h2 style="margin-top:5px; text-align:left;"class="cs-entry__title" id="titul">
                                                                                        <a href="/noticia/?id=${tituloConverted}" style="padding:0;">
